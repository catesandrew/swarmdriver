...
const buildSauceTunnelOwner = (envs) => {
  if (envs.SAUCE_TUNNEL_OWNER) {
    return envs.SAUCE_TUNNEL_OWNER
  }
}

const buildSauceTunnelName = (envs, prefix = 'tunnel') => {
...
const buildSauceBuildId = (envs, suffix = 'power') => {
...
export const parseSauceServiceSettings = (envs = {}) => {
  return {
...
export const buildSauceSettings = (opts = {}) => {
  return {
    // Your cloud service username.
    user: opts.user,
    // Your cloud service access key or secret key.
 ...
 *
 * @param {Object} [envs] - environment
 * @returns {Object} Returns an object parsed from environment
 */
export const parseSauceCapabilities = (envs = {}) => {
  return {
    ...
    ...(existy(envs.SAUCE_NETWORK_CAPTURE) && {
      networkCapture: parseBool(envs, 'SAUCE_NETWORK_CAPTURE'),
    }),
    ...(existy(envs.SAUCE_SETUP_DEVICE_LOCK) && {
      setupDeviceLock: parseBool(envs, 'SAUCE_SETUP_DEVICE_LOCK'),
    }),
    ...(existy(envs.SAUCE_CUSTOM_LOG_FILES) && {
      customLogFiles: parseList(envs, 'SAUCE_CUSTOM_LOG_FILES'),
    }),
 ...
 * @returns {Object} Returns an object parsed from environment
 */
export const parseSauceAndroidCapabilities = (envs = {}) => {
  return {
 ...
 * @returns {Object} Returns an object to be spread.
 */
export const buildSauceAndroidCapabilities = (opts = {}) => {
  return {
 ...
 * @returns {Object} Returns an object parsed from environment
 */
export const parseSauceAndroidRealDeviceCapabilities = (envs = {}) => {
  return {
    ...(existy(envs.ANDROID_BROWSER_NAME) && {
      browserName: envs.ANDROID_BROWSER_NAME,
    }),
 ...
 * @returns {Object} Returns an object to be spread.
 */
export const buildSauceAndroidRealDeviceCapabilities = (opts = {}) => {
  return {
 ...
 * @returns {Object} Returns an object parsed from environment
 */
export const parseSauceIosCapabilities = (envs = {}) => {
  return {
 ...
 * @returns {Object} Returns an object to be spread.
 */
export const buildSauceIosCapabilities = (opts = {}) => {
  return {
 ...
 * @returns {Object} Returns an object parsed from environment
 */
export const parseSauceIosRealDeviceCapabilities = (envs = {}) => {
  return {
    ...(existy(envs.IOS_BROWSER_NAME) && {
      browserName: envs.IOS_BROWSER_NAME,
    }),
 ...
 * @returns {Object} Returns an object to be spread.
 */
export const buildSauceIosRealDeviceCapabilities = (opts = {}) => {
  return {
    // - The name of the browser to run the test on. If this capability is
    //   provided then the driver will try to start the test in Web context mode
    //   (Native mode is applied by default). Read Automating hybrid apps for
 ...
 * @returns {Object} Returns an object parsed from environment
 */
export const parseSauceSafariCapabilities = (envs) => {
  return {
  }
}
 ...
 * @returns {Object} Returns an object to be spread.
 */
export const buildSauceSafariCapabilities = (opts = {}) => {
  return {
    sauceOptions: {
    }
  }
 ...
 * @returns {Object} Returns an object parsed from environment
 */
export const parseSauceChromeCapabilities = (envs) => {
  return {
  }
}
 ...
 * @returns {Object} Returns an object to be spread.
 */
export const buildSauceChromeCapabilities = (opts = {}) => {
  return {
    sauceOptions: {
    }
  }
 ...
 * @returns {Object} Returns an object parsed from environment
 */
export const parseSauceFirefoxCapabilities = (envs) => {
  return {
  }
}
 ...
 * @returns {Object} Returns an object to be spread.
 */
export const buildSauceFirefoxCapabilities = (opts = {}) => {
  return {
    sauceOptions: {
    }
  }
 ...
 *
 * @param {Object} [opts] - optional options
 * @returns {Object} Returns an object to be spread in `capability`.
 */
export const buildW3CWebDriverCapabilitiesRequired = (opts = {}) => {
  return {
    ...(existy(opts.browserName) && {
      browserName: opts.browserName,
    }),
 ...
 * @returns {Object} Returns an object to be spread in `capability`.
 */
export const buildW3CWebDriverBrowserCapabilitiesOptional = (opts = {}) => {
  return {
 ...
 *
 * @param {Object} [opts] - optional options
 * @returns {Object} Returns an object to be included in `sauce:options`.
 */
export const buildDesktopBrowserCapabilitiesSauceSpecificOptional = (opts = {}) => {
  return {
 ...
 * @returns {Object} Returns an object to be spread in `capability`.
 */
export const buildMobileAppiumCapabilities = (opts = {}) => {
  return {
 ...
 * @returns {Object} Returns an object to be spread in `capability`.
 */
export const buildMobileAppiumTimeoutCapabilities = (opts = {}) => {
  return {
 ...
 * @returns {Object} Returns an object to be spread in `capability`.
 */
export const buildMobileAppiumIosWebDriverAgentTimeoutCapabilities = (opts = {}) => {
  return {
    // TODO: Fill in docs and add env parsers
 ...
 * @returns {Object} Returns an object to be included in `sauce:options`.
 */
export const buildMobileAppAppiumCapabilitiesSauceSpecificOptional = (opts = {}) => {
  return {
 ...
 * @returns {Object} Returns an object to be included in `sauce:options`.
 */
export const buildDesktopMobileCapabilitiesSauceSpecificOptional = (opts = {}) => {
  return {
 ...
 * @returns {Object} Returns an object to be included in `sauce:options`.
 */
export const buildDesktopVirtualDeviceCapabilitiesSauceSpecificOptional = (opts = {}) => {
  return {
