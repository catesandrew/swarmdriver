...
export const parseAppiumServiceSettings = (envs) => {
  return {
...
export const parseAppiumSettings = (envs) => {
  return {
...
export const parseIosAppiumSettings = (envs) => {
  return {
...
export const parseAndroidAppiumSettings = (envs) => {
  return {
